...
namespace MoreMountains.TopDownEngine
{
    ...
    public class ChaserEnemy : MonoBehaviour
    {
        ...
        /// <summary>
        /// Drops loot - coins only (with tilemap validation)
        /// </summary>
        ...
        /// <summary>
        /// Finds a valid position for coin drop that's on a walkable tile
        /// </summary>
        private Vector3 GetValidCoinDropPosition()
        {
            ...
            if (ShowDebugInfo)
            {
                Debug.LogWarning($"{gameObject.name}: Could not find valid coin drop position, using enemy position");
            }
        ...
        private void FindWalkableTilemap()
        {
            ...
            {
                Debug.LogWarning("ChaserEnemy: No tilemap found in scene. Coins will drop without validation.");
            }
        }
