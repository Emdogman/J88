...
{
    /// <summary>
    /// Example script showing how to use the drunken legs animation system
    /// </summary>
    public class DrunkenLegsAnimationExample : MonoBehaviour
    {
        [Header("Animation Controls")]
        [Tooltip("The main drunken animation controller")]
        ...
        [Tooltip("Key to test legs animation directly")]
        public KeyCode testLegsKey = KeyCode.F;
        ...
        private void HandleInput()
        {
            ...
            // Test legs animation directly
            if (Input.GetKeyDown(testLegsKey))
            {
                TestLegsAnimation();
            }
        }
        ...
        public void ToggleDrunkenMode()
        {
            if (drunkenAnimation != null)
            {
                ...
                Debug.Log($"DrunkenLegsAnimationExample: Toggled drunken mode. Current state: {drunkenAnimation.IsDrunkenMode()}");
            }
            else
            {
                Debug.LogWarning("DrunkenLegsAnimationExample: No DrunkenCharacterAnimation component found!");
            }
        }
        ...
        public void TriggerDrunkenRun()
        {
            if (drunkenAnimation != null)
            {
                ...
                Debug.Log("DrunkenLegsAnimationExample: Triggered drunken run animation");
            }
            else if (animationController != null)
            {
                animationController.TriggerDrunkenRun();
                Debug.Log("DrunkenLegsAnimationExample: Triggered drunken run animation (basic controller)");
            }
            else
            {
                Debug.LogWarning("DrunkenLegsAnimationExample: No animation controller found!");
            }
        }
        ...
        public void TriggerIdle()
        {
            if (drunkenAnimation != null)
            {
                ...
                Debug.Log("DrunkenLegsAnimationExample: Triggered idle animation");
            }
            else if (animationController != null)
            {
                animationController.TriggerIdle();
                Debug.Log("DrunkenLegsAnimationExample: Triggered idle animation (basic controller)");
            }
            else
            {
                Debug.LogWarning("DrunkenLegsAnimationExample: No animation controller found!");
        ...
        public void ResetAnimation()
        {
            if (drunkenAnimation != null)
            {
                ...
                Debug.Log("DrunkenLegsAnimationExample: Reset animation (advanced controller)");
            }
            else if (animationController != null)
            {
                animationController.ResetAnimation();
                Debug.Log("DrunkenLegsAnimationExample: Reset animation (basic controller)");
            }
            else
            {
                Debug.LogWarning("DrunkenLegsAnimationExample: No animation controller found!");
        ...
        public void ToggleLegsSync()
        {
            if (legsAnimationController != null)
            {
                ...
                Debug.Log($"DrunkenLegsAnimationExample: Toggled legs sync to {!currentSync}");
            }
            ...
            {
                Debug.LogWarning("DrunkenLegsAnimationExample: No legs animation controller found!");
            }
        }
        
        /// <summary>
        /// Tests legs animation directly
        /// </summary>
        public void TestLegsAnimation()
        {
            if (legsAnimationController != null)
            {
                legsAnimationController.TriggerDrunkenFeet();
                Debug.Log("DrunkenLegsAnimationExample: Tested legs animation (basic controller)");
            }
            else if (legsCharacterAnimation != null)
            {
                legsCharacterAnimation.TriggerDrunkenFeet();
                Debug.Log("DrunkenLegsAnimationExample: Tested legs animation (advanced controller)");
            }
            else
            {
                Debug.LogWarning("DrunkenLegsAnimationExample: No legs animation controller found!");
        ...
        public void SetAnimationSpeed(float speed)
        {
            ...
            if (drunkenAnimation != null)
            {
                ...
                Debug.Log($"DrunkenLegsAnimationExample: Set animation speed to {speed}");
            }
            else if (animationController != null)
            {
                animationController.SetAnimationSpeed(speed);
                Debug.Log($"DrunkenLegsAnimationExample: Set animation speed to {speed} (basic controller)");
            }
        }
        ...
        public void LogCurrentAnimationState()
        {
            ...
            if (drunkenAnimation != null)
            {
                mainState = $"Main: Drunken={drunkenAnimation.IsDrunkenMode()}, Moving={drunkenAnimation.IsMoving()}";
            }
            else if (animationController != null)
            {
                mainState = $"Main: {animationController.GetCurrentAnimationState()}, Moving={animationController.IsMoving()}";
            }
            else
            {
                mainState = "Main: No controller found";
            }
            ...
            {
                legsState = "Legs: No controller found";
            }
            
            Debug.Log($"DrunkenLegsAnimationExample: {mainState} | {legsState}");
        }
        ...
        void OnGUI()
        {
            ...
            GUI.Label(new Rect(10, 10, 600, 20), $"Animation State: {GetAnimationStateDescription()}");
            ...
            GUI.Label(new Rect(10, 150, 300, 20), $"{testLegsKey} - Test Legs Animation");
        }
    }
}
